...
@injectable()
export class RecircWidget extends ReactWidget {

    static readonly ID = 'Recirc:widget';
    static readonly LABEL = 'Recirc Widget';
    ...
    protected async doInit(): Promise <void> {
        this.id = RecircWidget.ID;
        this.title.label = RecircWidget.LABEL;
        this.title.caption = RecircWidget.LABEL;
